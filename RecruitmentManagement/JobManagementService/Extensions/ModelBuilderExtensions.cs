...
public static class ModelBuilderExtensions
{
    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<JobOffer>().HasData(
            new JobOffer
            {
                Id = 1, Title = "Software Developer", LocationId = 1, Description = "Develop cutting-edge applications",
                Type = JobType.FullTime, Salary = 60000, PostedDate = DateTime.UtcNow
            },
            new JobOffer
            {
                Id = 2, Title = "System Administrator", LocationId = 2,
                Description = "Manage and maintain IT infrastructure", Type = JobType.FullTime, Salary = 50000,
                PostedDate = DateTime.UtcNow
            },
            new JobOffer
            {
                Id = 3, Title = "Database Administrator", LocationId = 3,
                Description = "Manage and maintain database systems", Type = JobType.FullTime, Salary = 55000,
                PostedDate = DateTime.UtcNow
            }
        );
    }
